      ...
      <div style={{ display: "flex", flex: 1, position: "relative" }}>
        ...
        {showPrivacyModal && (
          <div style={{ position: "fixed", top: 0, left: 0, width: "100%", height: "100%", backgroundColor: "rgba(0,0,0,0.6)", display: "flex", justifyContent: "center", alignItems: "center", zIndex: 2000, backdropFilter: "blur(5px)" }}>
            <div className="responsive-settings-modal" style={{ backgroundColor: "white", padding: "40px", borderRadius: "25px", width: "500px", boxShadow: "0 10px 25px rgba(0,0,0,0.2)" }}>
        ...
        {showNotifModal && (
          <div style={{ position: "fixed", top: 0, left: 0, width: "100%", height: "100%", backgroundColor: "rgba(0,0,0,0.6)", display: "flex", justifyContent: "center", alignItems: "center", zIndex: 2000, backdropFilter: "blur(5px)" }}>
            <div className="responsive-settings-modal" style={{ backgroundColor: "white", padding: "40px", borderRadius: "25px", width: "450px", boxShadow: "0 10px 25px rgba(0,0,0,0.2)" }}>
        ...
        {showPasswordModal && (
          <div style={{ position: "fixed", top: 0, left: 0, width: "100%", height: "100%", backgroundColor: "rgba(0,0,0,0.6)", display: "flex", justifyContent: "center", alignItems: "center", zIndex: 2000, backdropFilter: "blur(5px)" }}>
            <div className="responsive-settings-modal change-password-modal" style={{ backgroundColor: "#001166", padding: "50px", borderRadius: "35px", width: "850px" }}>
              <h2 style={{ color: "white", fontSize: "32px", fontWeight: "800", marginBottom: "35px" }}>Change Password</h2>
              <div style={{ display: "flex", flexDirection: "column", gap: "25px" }}>
                <div className="settings-modal-field-half" style={{ position: "relative", width: "48%" }}>
                ...
                <div className="settings-modal-row" style={{ display: "flex", gap: "30px" }}>
        ...
        {showConfirmModal && (
          <div style={{ position: "fixed", top: 0, left: 0, width: "100%", height: "100%", backgroundColor: "rgba(0,0,0,0.5)", display: "flex", justifyContent: "center", alignItems: "center", zIndex: 2100 }}>
            <div className="responsive-settings-modal" style={{ backgroundColor: "white", padding: "30px", borderRadius: "20px", textAlign: "center", width: "400px" }}>
        ...
        {showOtpModal && (
          <div style={{ position: "fixed", top: 0, left: 0, width: "100%", height: "100%", backgroundColor: "rgba(0,0,0,0.6)", display: "flex", justifyContent: "center", alignItems: "center", zIndex: 2150, backdropFilter: "blur(5px)" }}>
            <div className="responsive-settings-modal" style={{ backgroundColor: "white", padding: "40px", borderRadius: "25px", textAlign: "center", width: "400px" }}>
        ...
        {/* ----------------- SIDEBAR ----------------- */}
        <div className={`sidebar-container ${isMobileOpen ? 'sidebar-open' : ''}`} style={{ width: sidebarWidth, backgroundColor: "#001166", height: "100vh", color: "white", padding: "20px 15px", position: "fixed", transition: "width 0.3s ease", zIndex: 1000, display: "flex", flexDirection: "column", boxSizing: "border-box" }}>
          ...
          <nav style={{ flexGrow: 1 }}>
            <div style={getNavItemStyle("/dashboard")} onClick={() => { navigate("/dashboard"); setIsMobileOpen(false); }}><LayoutDashboard size={20} /> {!isCollapsed && "Dashboard"}</div>
            <div style={getNavItemStyle("/profile")} onClick={() => { navigate("/profile"); setIsMobileOpen(false); }}><User size={20} /> {!isCollapsed && "Profile"}</div>
            <div style={getNavItemStyle("/booking")} onClick={() => { navigate("/booking"); setIsMobileOpen(false); }}><CalendarHeart size={20} /> {!isCollapsed && "Book an Appointment"}</div>
            <div style={getNavItemStyle("/appointments")} onClick={() => { navigate("/appointments"); setIsMobileOpen(false); }}><History size={20} /> {!isCollapsed && "My Appointments"}</div>
            <div style={getNavItemStyle("/records")} onClick={() => { navigate("/records"); setIsMobileOpen(false); }}><FileText size={20} /> {!isCollapsed && "Records"}</div>
          </nav>
          <div style={{ borderTop: "1px solid rgba(255,255,255,0.2)", paddingTop: "10px" }}>
            <div style={getNavItemStyle("/settings")} onClick={() => { navigate("/settings"); setIsMobileOpen(false); }}><SettingsIcon size={20} /> {!isCollapsed && "Settings"}</div>
            <div style={{ ...getNavItemStyle("/logout"), color: "#ff4d4d" }} onClick={() => { handleLogout(); setIsMobileOpen(false); }}><LogOut size={20} /> {!isCollapsed && "Logout"}</div>
          </div>
        </div>

        {/* ----------------- MAIN CONTENT AREA ----------------- */}
        <div className="admin-main-content" style={{ marginLeft: sidebarWidth, width: `calc(100% - ${sidebarWidth})`, transition: "margin-left 0.3s ease" }}>
          <div className="settings-content-wrapper" style={{ padding: "60px 80px", maxWidth: "1200px" }}>
            <h1 className="settings-page-title" style={{ color: "#001166", fontSize: "48px", fontWeight: "800", marginBottom: "50px" }}>Settings</h1>
            ...
            {["Change Password", "Privacy & Security", "Notifications", "Preference"].map((label) => (
              ...
              >
                <h3 className="settings-card-label" style={{ color: "#001166", fontSize: "24px", fontWeight: "800", margin: 0 }}>{label}</h3>
