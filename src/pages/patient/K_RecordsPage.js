...
function RecordsPage() {
  ...
  const fetchData = useCallback(async (userId) => {
    ...
    try {
      const [analyticsRes, riskRes] = await Promise.all([
        fetch(`https://cautious-funicular-g4x9r6gg757399x9-8080.app.github.dev/api/patient/get/${userId}/analytics`),
        fetch(`https://cautious-funicular-g4x9r6gg757399x9-8080.app.github.dev/api/patient/get/${userId}/oral-health-risk`)
      ]);
  ...
  const handleDownloadReport = async () => {
    ...
    try {
      const [analyticsRes, riskRes] = await Promise.all([
        fetch(`https://cautious-funicular-g4x9r6gg757399x9-8080.app.github.dev/api/patient/get/${userData.id}/analytics`),
        fetch(`https://cautious-funicular-g4x9r6gg757399x9-8080.app.github.dev/api/patient/get/${userData.id}/oral-health-risk`)
      ]);
