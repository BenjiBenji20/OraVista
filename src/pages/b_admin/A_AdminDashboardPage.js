  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      try {
        ...
        const statsRes = await fetch('https://oravista-server-temporary-756513026425.asia-southeast1.run.app/api/dashboard/stats');

        // 2. Daily Earnings: Fetching real-time revenue per each branch[cite: 6]
        const earningsRes = await fetch('https://oravista-server-temporary-756513026425.asia-southeast1.run.app/api/dashboard/branch-earnings');
