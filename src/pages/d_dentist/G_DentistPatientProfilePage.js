        ...
        <div style={styles.content}>
          ...
          <div style={styles.dashboardGrid}>
            ...
            <div style={styles.rightCol}>
              ...
              {/* Treatment Notes[cite: 4, 9] */}
              <div style={styles.notesCard}>
                <h3 style={styles.cardTitle}>Clinical Treatment Notes</h3>
                {history.filter(h => h.status === 'Completed').length > 0 ? (
                  history.filter(h => h.status === 'Completed').slice(0, 2).map((note, idx) => (
                    <div key={idx} style={styles.noteItem}>
                      ...
                      <p style={styles.noteContent}>Clinical procedure completed. Follow-up required if pain persists.</p>
                  ...
                  <p style={{opacity: 0.6, fontSize: '14px'}}>No clinical notes available for this patient.</p>
                )}
              </div>
            </div>
          </div>
